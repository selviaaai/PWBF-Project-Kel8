            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    <div class="mb-4">
                        ...
                        <a href="/petcreatepage" class="btn btn-success mt-3">Add new pet</a>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn-group">
                                        <form action="/petdelete/{{ $hewan->id }}" method="Post">
                                            @csrf
                                            @method('PUT')
                                            <button type="submit" class="btn btn-danger active">Delete</button>
                                          </form>
                                    <a href="/petedit/{{ $hewan->id }}" class="btn btn-warning ms-2">Edit</a><td>
                                </tr>
                                @endforeach
