...
<!-- table user 1 -->
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    <div class="">
                        <h6 class="">User Table</h6>
                        <a href="/usercreatepage" class="mb-3 btn btn-success">Add New User</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tr>
                                    ...
                                    <td> --}}
                                    <td class="d-flex">
                                        <a href="/useredit/{{ $user->id }}" class="btn btn-warning m-1">Edit</a>
                                        <form action="/userdelete/{{ $user->id }}" method="Post">
                                            @csrf
                                            @method('PUT')
                                            <button type="submit" class="btn btn-danger active m-1">Delete</button>
                                          </form>
                                    <td>
                            </tr>
                    </div>
