                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                                ...
                                <tbody class="">
                                    ...
                                    <th scope="col">{{ $adopt->User['username'] }}</th>
                                    <th scope="col">{{ $adopt->Hewan['name'] }}</th>
                                    @foreach($kategori->where('id', $adopt->Hewan['kategoris_id']) as $kat) @endforeach
                                    <th scope="col">{{ $kat->name }}</th>
                                    <th scope="col">{{ $adopt->pickup_date }}</th>
                                    <th scope="col">{{ $adopt->status }}</th>
                                    <th scope="col">
                                        <a href="/adoptedit/{{ $adopt->id }}"><button class="btn btn-warning" style="border-radius: 15px">Change Status</button></a>
                                    </th>
                                </tbody>
                                @endforeach
                        </table>
