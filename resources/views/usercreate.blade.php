    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <h1 class="mt-4 text-white">Create New User</h1>
                            ...
                            <div class="col">
                                <div class="form-group mt-2">
                                    <strong >Fullame:</strong>
                                        <input type="text" name="fullname"  class="form-control mt-2" placeholder="Fullname" required>
                                </div>
                                <div class="form-group mt-2">
                                ...
                                <div class="form-group mt-2">
                                    <strong >Email:</strong>
                                        <input type="text" name="email" value="" class="form-control mt-2" placeholder="Email" required>
                                </div>
                                <div class="form-group mt-2">
                                    <strong >Phone Number:</strong>
                                        <input type="text" name="number" class="form-control mt-2" placeholder="Phone Number" required>
                                </div>
                                <div class="form-group mt-2">
                                    <strong >Address:</strong>
                                        <input type="text" name="alamat" class="form-control mt-2" placeholder="Address" required>
                                </div>
                                <div class="form-group mt-2">
                                    <strong >Role:</strong>
