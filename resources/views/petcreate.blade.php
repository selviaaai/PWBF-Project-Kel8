    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <h1 class="mt-4 text-white">Create New Pet</h1>
                <div class="card mt-4 mb-4">
                    ...
                    <div class="card-body">
                        <form action="/petcreate" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="col">
                                ...
                                <div class="form-group mt-2">
                                    <strong >Pet Breed:</strong>
                                        <input type="text" name="breed" class="form-control mt-2" placeholder="Pet Breed" required>
                                </div>
                                <div class="form-group mt-2">
                                    <strong >Pet Age:</strong>
                                        <input type="text" name="age" value="  Months" class="form-control mt-2" placeholder="Pet Age" required>
                                </div>
                                <div class="form-group mt-2">
                                    <strong >Pet Weight:</strong>
                                        <input type="text" name="weight" class="form-control mt-2" placeholder="Pet Weight" required>
                                </div>
                                <div class="form-group mt-2">
                                    <strong >Pet Sex:</strong>
                                        {{-- <input type="text" name="sex" class="form-control mt-2" placeholder="Pet Sex" required> --}}
                                        <select name="sex" type="text" class="form-select" readonly aria-label="Default select example">
                                            <option value="0">Male</option>
                                            <option value="1">Female</option>
                                        </select>
                                </div>
                                <div class="form-group mt-2">
                                    <strong >Pet Colour:</strong>
                                        <input type="text" name="colour" class="form-control mt-2" placeholder="Pet Colour" required>
                                </div>
                                <div class="form-group mt-2">
