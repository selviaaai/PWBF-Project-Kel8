...
<body>
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
        <div class="cards mt-4" style="background-color:#fff;">
            <img src="{{$report->img_link}}" style="height:300px;" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">Report from {{ $report->email }}</h5>
            <div class="row mt-2">
                <div class="col-sm-3">
                    <p>Reporter</p>
                    <p>Phone</p>
