    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <h1 class="mt-4 text-white">Manage Adoption Table</h1>
                <div class="card mt-4 mb-4">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="/adoptupdate/{{ $id }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="col">
                                <div class="form-group mt-2">
                                <select name="status" type="text" class="form-select" readonly aria-label="Default select example">
                                    <option value="adoption scheduled">Adoption Scheduled</option>
                                    <option value="adoption processed">Adoption Processed</option>
                                    <option value="adoption arrived">Adoption Arrived</option>
                                    <option value="adoption done">Adoption Done</option>
                                </select>
                                <label class="p-1 mt-2" for="">Current status : {{ $adoption->status}}</label>
                            </div>
